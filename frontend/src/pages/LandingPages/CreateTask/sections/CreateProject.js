    ...
    <div className="container mx-auto p-6">
      ...
      >
        ...
        <div className="flex justify-center mt-4">
          <button
            type="submit"
            className="py-2 px-5 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
          >
            {editIndex !== -1 ? "Update Project" : "Create Project"}
          </button>
        </div>
      </form>
      ...
      {showOverview && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            ...
            <p>
              <strong>Inventories:</strong> {inventories.map((inv) => inv.label).join(", ")}
            </p>
            <p>
              <strong>Workers Required:</strong> {workers}
            </p>
            <p>
